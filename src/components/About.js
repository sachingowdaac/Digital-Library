...
const About = () => (
  <div className="container-about m-5 justify-center justify-items-center text-justify">
    ...
    <p>
      ...
      site objective and unbiased, ratings are calculated purely based on data.
      We do not honor requests to feature books, nor are we getting any money
